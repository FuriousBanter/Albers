...
function draw() {
    ...
    for (let s = 0; s < shapes; s++) { //draw shape arrays
...
mouseReleased = () => {
    ...
    if (drawLock == 0) {
        ...
        let shape = new Shape("rect " + "x1: " + drawShapeX1 + " x2: " + drawShapeX2 + ", y1: " + drawShapeY1 + " y2: " + drawShapeY2, drawShapeX1, drawShapeY1, drawShapeW, drawShapeH);
        shapes = shapes + shape;
        console.log(shapes);
